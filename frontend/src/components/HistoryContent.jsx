  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex-1 relative">
          ...
          <input
            ...
            className="
              ...
              text-sm shadow-inner shadow-black/20
      ...
      <div className="rounded-2xl bg-white/[0.04] border border-white/[0.08] shadow-lg overflow-hidden backdrop-blur-xl">
        {/* Table Header */}
        <div className="hidden md:grid grid-cols-12 gap-4 px-6 py-3 bg-white/[0.03] border-b border-white/[0.08]">
        ...
        <div className="flex flex-col items-center justify-center py-16 text-center">
          <div className="w-16 h-16 rounded-2xl bg-white/[0.06] border border-white/[0.08] flex items-center justify-center mb-4">
            <FileVideo className="w-7 h-7 text-slate-500" />
          </div>
