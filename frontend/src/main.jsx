...
// Route /vid-admin/* to the new admin control plane (has its own BrowserRouter)
const IS_ADMIN_ROUTE = window.location.pathname.startsWith('/vid-admin')
